            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="card catch-main-card">
                <div class="card-header d-flex align-items-start justify-content-between gap-2 flex-wrap">
                  <div>
                    <h5 class="view-head-title"><i class="bx bx-show me-2"></i>View Completed Operation Dog</h5>
                    <nav aria-label="breadcrumb" class="view-head-breadcrumb">
                      <ol class="breadcrumb breadcrumb-style1 mb-0">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('view-completed-operation-dog-list') }}">View Completed Operation Dog</a></li>
                      </ol>
                    </nav>
                  </div>
                </div>
                ...
                <div class="card-body">
                  ...
                  <!-- Back button -->
                  <div class="mb-2">
                    <a href="{{ route('manage-completed-operation-dog-list') }}" class="btn-back-catch">
