            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="card catch-main-card">
                <div class="card-header d-flex align-items-start justify-content-between gap-2 flex-wrap">
                  <div>
                    <h5 class="view-head-title"><i class="bx bx-show me-2"></i>View Expired Dog</h5>
                    <nav aria-label="breadcrumb" class="view-head-breadcrumb">
                      <ol class="breadcrumb breadcrumb-style1 mb-0">
                        ...
                        <li class="breadcrumb-item">
                          <a href="{{ route('total-expired-dog-list') }}">Total Expired Dog List</a>
                        </li>
                        <li class="breadcrumb-item active"><a href="{{ route('view-expired-dog-list') }}">View Expired Dog</a></li>
                      </ol>
                    </nav>
                  </div>
                </div>
