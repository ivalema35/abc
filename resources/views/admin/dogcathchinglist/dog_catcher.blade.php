            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="card dog-catcher-head-card">
                <div class="dog-catcher-top-bar d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                  <div>
                    <h2 class="page-title d-flex align-items-center gap-2"><i class="fa-solid fa-dog"></i> Dog Catcher</h2>
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb page-subtitle mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('manage-dog-catcher') }}">Dog Catcher</a></li>
                      </ol>
                    </nav>
                  </div>
                  <a href="{{ route('add-dog-catcher') }}" class="addbtn btn btn-dark d-flex align-items-center gap-1">
                    <i class="fa-solid fa-plus"></i> Add
                  </a>
                </div>
                <div class="card dog-catcher-table-card">
                  <div class="card-header">
                    <h4 class="card-title">Dog Catcher List</h4>
                  </div>
                  <div class="card-body">
                      ...
                      <table id="dog-catcher-table" class="table table-striped border-top">
                        ...
                        <tbody>
                          <tr>
                            <td>1</td>
                            <td>292</td>
                            <td>Jaiprakash Nagar, Ahmedabad</td>
                            <td><img src="#" alt="Dog Catcher" class="img-fluid" /></td>
                            <td>13-03-2026 10:04:46</td>
                            <td>
                              <div class="d-flex table-action-btn">
                                <a class="action-icon-outline" href="{{ route('view-catching-staff') }}" aria-label="View">
                          ...
                          <tr>
                            ...
                            <td><img src="#" alt="Dog Catcher" class="img-fluid" /></td>
                            <td>11-03-2026 17:53:44</td>
                            <td>
                              <div class="d-flex table-action-btn">
                                <a class="action-icon-outline" href="view_dog_catcher.html" aria-label="View">
                                  <i class="bx bx-show"></i>
                                </a>
                              </div>
                            </td>
