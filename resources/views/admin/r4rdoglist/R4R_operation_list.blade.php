...
@endpush
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="project-top-bar d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                <div>
                  <h2 class="page-title d-flex align-items-center gap-2"><i class="fa-solid fa-tags"></i> R4R Operation List</h2>
                   <nav aria-label="breadcrumb">
                      <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('R4R-operation-list') }}">R4R Operation List</a></li>
      ...
      function renderCatchRows() {
        ...
        updateTable(
          filteredData
            .map(function (item) {
              const viewButton =
                '<a href="{{ route('view-r4r-operation-list') }}" class="action-view-btn" title="View information" aria-label="View information for operation ' +
                item.Id +
