            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="card catch-main-card">
                <div class="card-header d-flex align-items-start justify-content-between gap-2 flex-wrap">
                  <div>
                    <h5 class="view-head-title"><i class="bx bx-show me-2"></i>View R4R Dog</h5>
                  ...
                  <a href="{{ route('manage-r4r-dog-list') }}" class="btn-back-catch"> <i class="bx bx-arrow-back"></i> Back to List </a>
                </div>
                ...
                <div class="card-body">
                  ...
                  <!-- Back button -->
                  <div class="mb-2">
                    <a href="{{ route('manage-r4r-dog-list') }}" class="btn-back-catch">
