...
@push('styles')
    <style>
      ...
      #received-dog-master-table {
        margin-bottom: 0;
      }

      #received-dog-master-table thead th {
        font-size: 0.84rem;
        font-weight: 700;
      ...
      #received-dog-master-table tbody td {
        font-size: 0.95rem;
        color: #4b5563;
        padding-top: 0.95rem;
      ...
      #received-dog-master-table tbody tr {
        transition: background-color 0.2s ease;
      }

      #received-dog-master-table tbody tr:hover {
      ...
      #received-dog-master-table_wrapper .page-item.active .page-link {
        background-color: #0f0f13 !important;
        border-color: #0f0f13 !important;
        color: #ffffff !important;
      }

      #received-dog-master-table_wrapper .page-item.active .page-link:hover,
      #received-dog-master-table_wrapper .page-item.active .page-link:focus {
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="card dog-master-head-card">
                <div class="dog-top-bar d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                  <div>
                    <h2 class="page-title d-flex align-items-center gap-2"><i class="fa-solid fa-receipt"></i> Received Dog List</h2>
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb page-subtitle mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('manage-catch-process') }}">Catch Process</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('manage-received-dog-list') }}">Received Dog List</a></li>
                      </ol>
                    </nav>
                  </div>
                ...
                <div class="card dog-list-card">
                  <div class="card-header">
                    <h4 class="card-title">Received Dog List</h4>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table id="received-dog-master-table" class="table table-striped border-top">
                        <thead>
                          <tr>
                            <th>ID</th>
                            <th>Tag No</th>
