...
@push('styles')
    <style>
      ...
      #rejected-dog-master-table {
        margin-bottom: 0;
      }

      #rejected-dog-master-table thead th {
        font-size: 0.84rem;
        font-weight: 700;
      ...
      #rejected-dog-master-table tbody td {
        font-size: 0.95rem;
        color: #4b5563;
        padding-top: 0.95rem;
      ...
      #rejected-dog-master-table tbody tr {
        transition: background-color 0.2s ease;
      }

      #rejected-dog-master-table tbody tr:hover {
      ...
      #rejected-dog-master-table_wrapper .page-item.active .page-link {
        background-color: #0f0f13 !important;
        border-color: #0f0f13 !important;
        color: #ffffff !important;
      }

      #rejected-dog-master-table_wrapper .page-item.active .page-link:hover,
      #rejected-dog-master-table_wrapper .page-item.active .page-link:focus {
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="card dog-master-head-card">
                <div class="dog-top-bar d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                  <div>
                    <h2 class="page-title d-flex align-items-center gap-2"><i class="fa-solid fa-receipt"></i> Rejected Dog List</h2>
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb page-subtitle mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('manage-catch-process') }}">Catch Process</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('rejected-dog-list') }}">Rejected Dog List</a></li>
                      </ol>
                    </nav>
                  </div>
                ...
                <div class="card dog-list-card">
                  <div class="card-header">
                    <h4 class="card-title">Rejected Dog List</h4>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table id="rejected-dog-master-table" class="table table-striped border-top">
                        <thead>
                          <tr>
                            <th>ID</th>
                            <th>Tag No</th>
