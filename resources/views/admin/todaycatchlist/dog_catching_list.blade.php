              ...
              <div class="card dog-catcher-head-card">
                  ...
                  <div>
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb page-subtitle mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('dog-catching-list') }}">Dog Catching</a></li>
                      </ol>
                    </nav>
                  </div>
                </div>
                <div class="card dog-catcher-table-card">
                  <div class="card-header">
                    <h4 class="card-title">Dog Catching List</h4>
                  </div>
                  <div class="card-body">
                      ...
                      <table id="dog-catcher-table" class="table table-striped border-top">
                        ...
                        <tbody>
                          <tr>
                            <td>1</td>
                            <td>206</td>
                            <td>chandreshnagar Rajkot Gujarat-360004 India</td>
                            <td>
                              <div class="d-flex table-action-btn">
                                <a class="action-icon-outline" href="{{ route('view-catch') }}" aria-label="View">
