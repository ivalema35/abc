            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="card catch-main-card">
                  ...
                  <div>
                    ...
                    <nav aria-label="breadcrumb" class="view-head-breadcrumb">
                      <ol class="breadcrumb breadcrumb-style1 mb-0">
                        ...
                        <li class="breadcrumb-item">
                          <a href="{{ route('today-catch-list') }}">Today's Catch List</a>
                        </li>
                        <li class="breadcrumb-item">
                          <a href="{{ route('dog-catching-list') }}">Dog Catching</a>
                        </li>
                        <li class="breadcrumb-item active"><a href="{{ route('view-catch') }}">View Catch Details</a></li>
                      </ol>
                    </nav>
                  </div>
                ...
                <div class="card-body">
                    ...
                    <div class="col-xl-4 col-md-5">
                      <div class="catch-img-card">
                        ...
                        <div class="catch-img-meta">
                          <div class="fw-bold">Chandreshnagar Rajkot</div>
                          <div>Gujarat â€“ 360004</div>
                          <div>India</div>
                        ...
                        <table class="catch-info-table">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="val" colspan="5">Chandreshnagar Rajkot Gujarat â€“ 360004 India</td>
                            </tr>
                            <tr>
                    ...
                    <div class="col-xl-8 col-lg-7 col-md-6">
                      ...
                      <div class="catch-sub-card">
                        <table class="catch-sub-table">
                          <thead>
                            <tr>
                              <th colspan="3" class="text-center">Datewise Details</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
                              ...
                              <td class="date-cell">
                                ...
                                2026-03-12 11:13:51
                                <td><i class="fa-solid fa-stethoscope"></i> Dr kishan kathiriya</td>
                              </td> 
                            </tr>
                            <tr>
                  ...
                  <!-- Back button -->
                  <div class="mb-2">
                    <a href="{{ route('dog-catching-list') }}" class="btn-back-catch">
